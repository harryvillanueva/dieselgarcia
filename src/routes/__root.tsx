  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="btn-base btn-cta">
            Volver al inicio
          </Link>
        </div>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "dieselgarcia.com | Recambio diésel de alto rendimiento" },
      {
        name: "description",
        content:
          "Tienda de recambio diésel: inyectores, turbos, filtros y lubricantes con garantía de taller.",
      },
      { property: "og:site_name", content: "dieselgarcia.com" },
